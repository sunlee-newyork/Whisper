  ...
  chrome.storage.sync.get(function (result) {
    ...
    if (result.first_checkbox === true) { 
      ...
      if (result.first) {
        ...
        $('#first_link').html(result.first_name+' (click to assign)');
    ...
    if (result.second_checkbox === true) { 
      ...
      if (result.second) {
        ...
        $('#second_link').html(result.second_name+' (click to assign)');
    ...
    if (result.third_checkbox === true) { 
      ...
      if (result.third) {
        ...
        $('#third_link').html(result.third_name+' (click to assign)');
    ...
    if (result.fourth_checkbox === true) { 
      ...
      if (result.fourth) {
        ...
        $('#fourth_link').html(result.fourth_name+' (click to assign)');
    ...
    if (result.fifth_checkbox === true) { 
      ...
      if (result.fifth) {
        ...
        $('#fifth_link').html(result.fifth_name+' (click to assign)');
